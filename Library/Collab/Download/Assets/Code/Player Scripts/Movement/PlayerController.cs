...
public class PlayerController : MonoBehaviour
{
    ...
    public BoxCollider2D wallBumpL;
    public BoxCollider2D wallBumpR;
    ...
    void Update()
    {
        ...
        if (Input.GetAxis("Horizontal") != 0f)
        {
            ...
            if (rb.velocity.x > speedLimit + 1 || rb.velocity.x < -speedLimit - 1)
            {
        ...
        // Wall Jumps
        if (Input.GetKeyDown(KeyCode.S) && canWallJumpL && !hasWallJumpedL)
        {
            WallJump(1);
            canWallJumpL = false;
        ...
        if (Input.GetKeyDown(KeyCode.S) && canWallJumpR && !hasWallJumpedR)
        {
            WallJump(-1);
            canWallJumpR = false;
